...
public class GameManager4 : MonoBehaviour
{
    ...
    void Start()
    {
        // read the topic selected from log.txt
        ReadTopic();
    ...
    void Update()
    {
        // if there are no more questions left to answer
        if (unansweredQuestions == null || unansweredQuestions.Count == 0)
        {
            // alert in console
    ...
    public void SetUnanswerToNull()
    {
        // set unsanswered questions to null
    ...
    public void LoadQuestions()
    {
        ...
        object[] objs = Resources.LoadAll(topic, typeof(Question1));
    ...
    public void WriteScoreToDoc()
    {
        ...
        // convert score integer into string
    ...
    void ReadTopic()
    {
        ...
        // reader assigned to path
        StreamReader reader = new StreamReader(path);

        // assign topic variable to contents of file
        topic = reader.ReadToEnd();
    }
